...
contract RebaseTokenTest is Test {
    ...
    function testRedeemAfterTimePassed(uint256 depositAmount, uint256 time) public {
        ...
        // 2.1 Add the reward to the vault
    ...
    function testGetPrincipleBalance(uint256 amount) public {
        ...
        vm.prank(user);
        vault.deposit{value: amount};
        assertEq(rebaseToken.pricipleBalanceOf(user), amount);
    ...
    function testInterestRateCanOnlyDecrease(uint256 newInterestRate) public {
        ...
        vm.prank(owner);
        vm.expectPartialRevert(RebaseToken.RebaseToken__IntrestRateCanOnlyDecrease.selector);
        rebaseToken.setInterestRate(newInterestRate);
